...
export default function Navbar () {
    return (
            ...
            <nav className="bg-white z-20 top-0 start-0 sticky border-b border-gray-200">
                <div className="w-screen flex justify-between p-4">
                <a href="#" className="flex w-1/4 items-center space-x-3 rtl:space-x-reverse">
                    {/* <img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="Flowbite Logo"/> */}
                    <span className="self-center text-2xl font-semibold whitespace-nowrap">N-Market</span>
                </a>
                <div className="flex md:order-2 w-1/4 space-x-3 md:space-x-0 rtl:space-x-reverse">                    
