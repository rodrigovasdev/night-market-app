    ...
    return (
            <footer className="bg-neutral-950 border-t border-gray-200 ">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6">
                        <div>
                            ...
                            <ul className="text-gray-400 font-medium">
                                ...
                                <li>
                                    <Link href="https://portfolio-sigma-topaz-13.vercel.app/" className="hover:underline">Contacto</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm  sm:text-center text-gray-400">© 2025 <a href="https://flowbite.com/" className="hover:underline">N-Market™</a>. Todos los derechos reservados.
                    </span>
