    ...
    return (
        <Container>
            <CardContainer>
                ...
                <h1 className="font-bold text-3xl md:text-4xl text-center w-3/8 sm:w-1/4 2xl:w-1/8 mx-auto py-5 ">STAY UPDATED</h1>
                
                <div className="w-4/5 p-5 mx-auto md:w-full md:mx-0 text-center">
                    <span className="text-sm md:text-base text-center" >Suscribe to receive exclusive offers, updates, and the latest news from N-Market!</span>
                </div>
                ...
                <form action="" className="w-4/5 md:w-3/5 mx-auto">
                    <div className="flex gap-1 py-5">
                        ...
                        <Button type="icon" border="border-none"  paddingY="py-3" paddingX="px-0" width="w-10" heigth="h-10" >
