...
export default function Jumbotron() {
    ...
    return (
        ...
        <div className="w-full h-full py-10 px-40 bg-gray-200 ">
            <div className="bg-white w-7/8 mx-auto flex flex-col gap-10 rounded-xl py-10 border-1 border-gray-300 ">
                <h1 className="font-bold text-5xl text-center p-10">Stay Updated</h1>
