    ...
    <>
      ...
      <div className="relative h-56 overflow-hidden rounded-lg md:h-14/15">
          ...
          <div className="duration-200 ease-linear" data-carousel-item>
            ...
            ></Image>
            <div className="flex justify-around px-5 w-1/5 gap-6 z-10 absolute top-2/3 start-1/2 translate-x-[-50%] translate-y-[-50%]">
                <Button content="Buy now" width="w-2/5" paddingY="py-3" heigth="h-full" variant="primary"></Button>
                <Button content="Show more" width="w-3/5" paddingY="py-3"  heigth="h-full" variant="secondary"></Button>
            </div>
          </div>
