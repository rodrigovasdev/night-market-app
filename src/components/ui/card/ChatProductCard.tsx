...
export default function ChatProductCard({ id, name, imageUrl }: ChatProductCardProps) {
  return (
    <Link href={`/products/${id}`}>
      <div className="flex w-28 flex-col items-center gap-2 border border-neutral-200 bg-white p-2 shadow-sm transition hover:border-neutral-950 hover:shadow-md">
